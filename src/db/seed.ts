...
async function semerContenu() {
  const entrees: Array<{ cle: string; rubrique: string; libelle: string; valeur: unknown }> = [
    ...
    { cle: "accueil.hero.photo", rubrique: "photos", libelle: "Page d’accueil — la grande photo", valeur: hero.photo },
    { cle: "photos.adoptes.1", rubrique: "photos", libelle: "Page « Adoptés » — photo 1 (la plus grande)", valeur: { src: "/images/animaux/lilou.jpg", alt: "Lilou, adoptée, installée chez elle" } },
    { cle: "photos.adoptes.2", rubrique: "photos", libelle: "Page « Adoptés » — photo 2", valeur: { src: "/images/animaux/ficelle.jpg", alt: "Ficelle, adoptée, au soleil" } },
    { cle: "photos.adoptes.3", rubrique: "photos", libelle: "Page « Adoptés » — photo 3", valeur: { src: "/images/animaux/caline.jpg", alt: "Câline, chatte recueillie par l’association" } },
    { cle: "photos.adoptes.4", rubrique: "photos", libelle: "Page « Adoptés » — photo 4", valeur: { src: "/images/animaux/nala.jpg", alt: "Nala, chienne recueillie par l’association" } },
    { cle: "photos.association", rubrique: "photos", libelle: "Page « L’association »", valeur: { src: "/images/pages/association.jpg", alt: "Bénévoles de l’association auprès des animaux" } },
    { cle: "photos.don", rubrique: "photos", libelle: "Page « Faire un don »", valeur: { src: "/images/pages/don.jpg", alt: "Animaux recueillis par l’association, bénéficiaires des dons" } },
    { cle: "photos.adoption", rubrique: "photos", libelle: "Catalogue — encart du bas de page", valeur: { src: "/images/pages/adoption-encart.jpg", alt: "Chien accueilli temporairement dans une famille d’accueil" } },
